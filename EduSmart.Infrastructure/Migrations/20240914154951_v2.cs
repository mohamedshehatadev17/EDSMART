    ...
    public partial class v2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompletionCertificates_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonsCompletions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonsCompletions_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonsCompletions_Students_studentId",
                        column: x => x.studentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletionCertificates_StudentId",
                table: "CompletionCertificates",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonsCompletions_LessonId",
                table: "LessonsCompletions",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonsCompletions_studentId",
                table: "LessonsCompletions",
                column: "studentId");
